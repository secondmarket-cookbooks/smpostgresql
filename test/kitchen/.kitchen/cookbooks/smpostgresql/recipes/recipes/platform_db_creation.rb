...
plat_dbname   = "plat_#{node.chef_environment}"
integration_dbname   = "integration_#{node.chef_environment}"

# By default, the usernames for each database are the same as the DB
...
# TODO: itg_admin. Or give individual users the rights to get onto the DBs
