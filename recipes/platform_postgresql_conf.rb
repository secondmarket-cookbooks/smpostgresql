...
# SOP-2902: PostgreSQL replication isn't great, and any rows removed from the master by the autovacuum process
# may cause long-running slave queries to fail, so defer autovacuum cleanup by 1000 transactions.
node.set['postgresql']['config']['vacuum_defer_cleanup_age'] = '1000'
